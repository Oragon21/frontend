...
class MeasurementsResult {
  ...
  private hamburgerMenu = document.createElement("div");
  private navMenuContainer = document.createElement("div");
  private measurementResultsTextarea = document.createElement("textarea");
  ...
  private displayNavigationMenu(): void {
  ...
  public displayMeasurementResults(results: string): void {
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const measurementResultsString =
