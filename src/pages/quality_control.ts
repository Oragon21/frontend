...
module page1 {
  ...
  function handleYesAction(): void {
    ...
    popupMessage.textContent =
      "Are you sure you want to perform the quality test?";
  ...
  function displayMessagePage1(message: string): void {
  ...
  function navigateTo(page: { title: string; content: string }): void {
    ...
    const pageUrlMap: Record<string, string> = {
      Home: "../index.html", // Update the URL accordingly
      "Page 2": "page2.html", // Update the URL accordingly
